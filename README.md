...
- <img src="https://testdino.com/wp-content/uploads/2025/10/Testdino.svg" height="20" /> [testdino-hq/testdino-mcp](https://github.com/testdino-hq/testdino-mcp) – A Model Context Protocol (MCP) server that connects TestDino to AI agents. This server enables you to interact with your TestDino test data directly through natural language commands.
